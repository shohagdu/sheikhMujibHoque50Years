<div class="container-fluid bg-secondary text-white mt-5 pt-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            <h5 class="font-weight-bold text-primary mb-4">Information</h5>
            <div class="d-flex flex-column justify-content-start">
                <a class="text-white mb-2" href="{{ url('/purchaseGuide')}}"><i class="fa fa-angle-right text-primary
                mr-2"></i>Purchase Guide</a>
                <a class="text-white mb-2" href="{{ url('/privacyPolicy')}}"><i class="fa fa-angle-right text-primary
                mr-2"></i>Privacy Policy</a>
                <a class="text-white mb-2" href="{{ url('/termsOfService')}}"><i class="fa fa-angle-right text-primary
                mr-2"></i>Terms of Service</a>
                <a class="text-white mb-2" href="{{ url('/refundReturns')}}"><i class="fa fa-angle-right text-primary
                mr-2"></i>Refund & Returns</a>
            </div>
        </div>
    </div>
    <div class="row">
