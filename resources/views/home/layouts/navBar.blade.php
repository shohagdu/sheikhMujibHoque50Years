<div class="container-fluid nav-bar p-0" style="z-index: 999; position: fixed; top: 0px;  left: 0px;background-color:
 #285074">
...
{{--                    <a href="{{ url('/donationProcess')}}" class="nav-item nav-link">রেজিস্ট্রেশন প্রক্রিয়া</a>--}}
                    <a href="{{ url('/registrationProcess')}}" class="nav-item nav-link">রেজিস্ট্রেশন প্রক্রিয়া</a>
...
{{--                    <a href="{{ url('/aboutUs')}}" class="nav-item nav-link">আমাদের সম্পর্কে</a>--}}
                    ...
                    <a href="{{ url('/signUp')}}" class="nav-item nav-link">রেজিস্ট্রেশন</a>
